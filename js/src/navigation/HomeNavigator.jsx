...
import { Home, ChooseMode, Welcome, PosAndNeg, LoadModel, SpeedMode, ModelName, ProjectionMode, Projection, Filter, Search, Info, History, } from "../screens/home/index";
const Stack = createStackNavigator();
export default function Navigation() {
    return (<Stack.Navigator headerMode="none" initialRouteName="Welcome">
