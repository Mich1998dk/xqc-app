...
export default function ModeOption({ onPress, onDelete, style, model }) {
    var stats = [
        {
            title: "CREATED",
        ...
        {
            title: "FILTERS",
            value: model.filter.activities.length +
      ...
      <View style={styles.bottom}>
        <View style={{ flexDirection: "row" }}>
          {stats.map((item, index) => {
            return (<View key={index} style={styles.stat}>
        ...
        <Icon type="delete" onPress={onDelete}/>
      </View>
    </TouchableOpacity>);
}
